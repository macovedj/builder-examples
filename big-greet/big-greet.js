...
const $init = (async() => {
  const module0 = fetchCompile(new URL('./big-greet.core.wasm', import.meta.url));
  const module1 = fetchCompile(new URL('./big-greet.core2.wasm', import.meta.url));
  ...
  const module4 = fetchCompile(new URL('./big-greet.core3.wasm', import.meta.url));
  const module5 = fetchCompile(new URL('./big-greet.core4.wasm', import.meta.url));
