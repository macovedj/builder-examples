...
const $init = (async() => {
  const module0 = fetchCompile(new URL('./new-big-greet.core.wasm', import.meta.url));
  const module1 = fetchCompile(new URL('./new-big-greet.core2.wasm', import.meta.url));
  const module2 = base64Compile('');
  const module3 = base64Compile('');
  const module4 = fetchCompile(new URL('./new-big-greet.core3.wasm', import.meta.url));
  const module5 = fetchCompile(new URL('./new-big-greet.core4.wasm', import.meta.url));
  const module6 = base64Compile('');
  const module7 = base64Compile('');
